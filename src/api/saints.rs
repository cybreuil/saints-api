...
//     CreateSaint, Saint, SaintListItem, SaintQuery, SaintTranslation, UpdateSaint,
// };
...
// // --- GET /saints/fulllist (only admin) ──────────────────────────────────────────────────────────────

// async fn list_all_saints(
//     pool: web::Data<PgPool>,
//     // req: HttpRequest,
// ) -> Result<HttpResponse, ApiError> {
...
//     Ok(HttpResponse::Ok().json(saints))
// }
...
//             "slug and default_name are required".into(),
//         ));
//     }
...
//         .route("/fulllist", web::get().to(list_all_saints))
